        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    final WebDetection annotation = batchResponse.getResponses().get(0).getWebDetection();
                    TextAnnotation text = batchResponse.getResponses().get(0).getFullTextAnnotation();
                    //Paso 7
                    final List<WebImage> result=annotation.getFullMatchingImages();
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            TextView imageDetail = (TextView)findViewById(R.id.textView2);

                            imageDetail.setText((CharSequence) result);
                        }
                    });
